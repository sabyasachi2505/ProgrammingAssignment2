#The following two functions can be used to create a matrix and calculate its #inverse with the ability to cache the 
...
cacheSolve <- function(x, ...) {
        ...
        #CONDITION IS FALSE: inverse of the given matrix is calulated newly
        i <- solve(data, ...)
        x$setinverse(i)
